...
export const obj = {
    ...
    subscribe() {},
    unsubscribe() {},
    sub_function: () => increment.call(obj),
    subscribe() {
        EventEmitter.on('click', this.sub_function);
    },
    unsubscribe() {
        EventEmitter.off('click', this.sub_function);
    },
};
...
export const obj1 = {
    first(...args) {
        let reverse_args = args.reverse();
        this.second(...reverse_args);
    },
    second() {
